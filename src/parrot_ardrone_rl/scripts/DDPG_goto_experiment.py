...
if __name__ == '__main__':
    ...
    # Init Gym ENV
    task_env = rospy.get_param('/parrotdrone/env_name')
    env = GymMake(task_env)
    rospy.loginfo("Gym environment done")

    # Set the logging system
    rospack = rospkg.RosPack()
    pkg_path = rospack.get_path('parrotdrone_rl')
    ...
    Alpha = rospy.get_param("/parrotdrone/alpha")
    Epsilon = rospy.get_param("/parrotdrone/epsilon")
    Gamma = rospy.get_param("/parrotparrotdrone/gamma")
    epsilon_discount = rospy.get_param("/parrotdrone/epsilon_discount")
    nepisodes = rospy.get_param("/parrotdrone/nepisodes")
    nsteps = rospy.get_param("/parrotdrone/nsteps")
